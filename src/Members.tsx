      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-xl font-bold text-gray-900">twitter bot</h1>
          </div>
          ...
          <nav className="p-4">
            <ul className="space-y-2">
              <li>
                <a 
                  href="#dashboard" 
                  className="flex items-center space-x-3 px-4 py-3 text-orange-600 bg-orange-50 rounded-lg font-medium"
                >
                ...
                <div className="h-64 flex items-end justify-between space-x-2 px-4">
                  {salesData.map((item, index) => (
                    <div key={index} className="flex flex-col items-center flex-1">
                      <div 
                        className="bg-orange-500 w-full rounded-t-md hover:bg-orange-600 transition-colors relative group"
