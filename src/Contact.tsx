...
export default function Contact() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-orange-600 to-orange-800 py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Contact twitter bot</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hello@twitterbot.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8">
              ...
              <form className="space-y-6">
                ...
                <button 
                  type="submit"
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white py-4 px-8 rounded-xl font-semibold text-lg flex items-center justify-center space-x-2 transition-all duration-300 transform hover:scale-105"
                >
